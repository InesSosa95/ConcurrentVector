...
public class ConcurrentVector {
    ...
    synchronized public void set(double d) {
        ...
        for (int i = 0; i < threadPool.dimension(); i++) {
            ...
            Task task = new Task(i, Instruction.Set, v, d);
            buffer.push(task);
        }
    ...
    synchronized public void assign(SequentialVector v) {
        ...
        for (int i = 0; i < threadPool.dimension(); i++) {
            ...
            Task task = new Task(i, Instruction.Assign, selfSlice, otherSlice);
            buffer.push(task);
        }
    ...
    synchronized public void assign(SequentialVector mask, SequentialVector v) {
        ...
        for (int i = 0; i < threadPool.dimension(); i++) {
            ...
            Task task = new Task(i, Instruction.AssignWithMask, selfSlice, otherSlice, maskSlice);
            buffer.push(task);
        }
    ...
    synchronized public void add(SequentialVector v) {
        ...
        for (int i = 0; i < threadPool.dimension(); i++) {
            ...
            Task task = new Task(i, Instruction.Add, selfSlice, otherSlice);
            buffer.push(task);
        }
    ...
    synchronized public void mul(SequentialVector v) {
        ...
        for (int i = 0; i < threadPool.dimension(); i++) {
            ...
            Task task = new Task(i, Instruction.Mul, selfSlice, otherSlice);
            buffer.push(task);
        }
    ...
    synchronized public void abs() {
        ...
        for (int i = 0; i < threadPool.dimension(); i++) {
            ...
            Task task = new Task(i, Instruction.Abs, v);
            buffer.push(task);
        }
    ...
    synchronized public double sum() {
        if (sequentialVector.dimension() <= threadPool.dimension()) {
            ...
            Task task = new Task(1, Instruction.Sum, v);
            buffer.push(task);
        } else {
            waitUntilWorkIsDone();
            ...
            for (int i = 0; i < threadPool.dimension(); i++) {
                ...
                Task task = new Task(i, Instruction.Sum, v);
                buffer.push(task);
            }
        }
    ...
    synchronized public double mean() {
        if (sequentialVector.dimension() <= threadPool.dimension()) {
            ...
            Task task = new Task(0, Instruction.Mean, v);
            buffer.push(task);
        } else {
            waitUntilWorkIsDone();
            ...
            for (int i = 0; i < threadPool.dimension(); i++) {
                ...
                Task task = new Task(i, Instruction.Mean, v);
                buffer.push(task);
            }
        }
    ...
    synchronized public double prod(SequentialVector v) {
        ...
        if (sequentialVector.dimension() <= threadPool.dimension()) {
            ...
            Task task = new Task(1, Instruction.Prod, sequentialVector, v);
            buffer.push(task);
        } else {
            waitUntilWorkIsDone();
            ...
            for (int i = 0; i < threadPool.dimension(); i++) {
                ...
                Task task = new Task(i, Instruction.Prod, selfSlice, otherSlice);
                buffer.push(task);
            }
        }
    ...
    synchronized public double norm() {
        if (sequentialVector.dimension() <= threadPool.dimension()) {
            ...
            Task task = new Task(1, Instruction.Norm, v);
            buffer.push(task);
            ...
            for (int i = 0; i < threadPool.dimension(); i++) {
                ...
                Task task = new Task(i, Instruction.Norm, v);
                buffer.push(task);
            }
    ...
    synchronized public double max() {
        ...
        if (sequentialVector.dimension() <= threadPool.dimension()) {
            ...
            Task task = new Task(0, Instruction.Max, v);
            buffer.push(task);
        } else {
            threadPool.setWorkToDo(threadPool.dimension());
            ...
            for (int i = 0; i < threadPool.dimension(); i++) {
                ...
                Task task = new Task(i, Instruction.Max, v);
                buffer.push(task);
            }
        }
    ...
    private void mergeWithThreadPoolVectors() {
        ...
        SortedSet<Integer> keys = new TreeSet<Integer>(threadPool.resultVectors().keySet());
        for (Integer key : keys) {
            SequentialVector s = threadPool.resultVectors().get(key);
            for (int i = 0; i < s.dimension(); i++) {
                this.set(cont, s.get(i));
                cont++;
            }
        }
    }
